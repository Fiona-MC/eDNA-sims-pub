...
# ./run_spiecEasiSimAnalysis.sh /space/s1/fiona_callahan/sim_paper_stuff/multiSim_100sp_revision_test 1 glasso 100 1 0

sim_dir=/space/s1/fiona_callahan/sim_paper_stuff/multiSim_100sp_revision_test
numRuns=1
seMethod=glasso
numSamples=100
logi=1
