...
resDirName="/space/s1/KaiyuanLi/data/JAGS/results/filtered/sp10_100_filtered"
...
do
    (
        ...
        #then
            ...
            timeout -k 10 10d Rscript /home/KaiyuanLi/current_code/JAGS/sim_data/sp10.r ${folder}/ ${resDirName}/${num}/ ${sitetab}
