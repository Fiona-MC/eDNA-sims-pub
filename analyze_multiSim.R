...
for(row in 1:dim(multiSimRes)[1]) {
...
randomParms <- c("num_samples_time", "num_samples_space", "radius", "actual_mean_fpr", "fpr.mode", "covNoise_sd", "covMeasureNoise_sd", "r", "sigma", "N_50", "mean_mig_rate", "c2")
