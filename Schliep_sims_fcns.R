...
numMistakes <- function(plotPosteriorTableOut, simParms, trial, simRun) {
    ...
    num_incorrect_alpha <- count_incorrectT1_alpha
    num_incorrect_beta <- count_incorrectT1_beta
    num_correctInferences <- num_correct
    num_incorrectInferences <- count_incorrectT1
    num_missedEffects_alpha <- num_missedEffects_alpha
    num_missedEffects_beta <- num_missedEffects_beta
    num_missedEffects <- num_missedEffects
    ...
    num_possibleEffects <- dim(actualBeta)[1] * dim(actualBeta)[2] + dim(actualAlpha)[1]^2 - dim(actualAlpha)[1]

    df <- data.frame(simRun = simRun,
                trial = trial, 
                num_incorrect_alpha = num_incorrect_alpha,
                num_incorrect_beta = num_incorrect_beta,
                num_correctInferences = num_correctInferences, 
                num_incorrectInferences = num_incorrectInferences, 
                num_actualEffects = num_actualEffects,
                num_missedEffects_alpha = num_missedEffects_alpha,
                num_missedEffects_beta = num_missedEffects_beta,
                num_missedEffects = num_missedEffects,
